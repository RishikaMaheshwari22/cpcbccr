...
for site_row in site_table:
    ...
    fromDate = "10-05-2021"  #TODO 2: starting date
    endDate = "12-05-2021"   #TODO 3: ending date, will be next day after that day
    how_many_days = 2
